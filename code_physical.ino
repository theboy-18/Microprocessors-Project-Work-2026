...
void setup() {
 ...
 mq2.begin();//initilaizing mq2 gas sensor
}

void loop() {
  lcd.setCursor(0,1);
  float smoke = mq2.readSmoke();//read smoke(test element) concentration(ppm)
